...
public class TemperatureSeriesAnalysisTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testLessEmptyArray() {
        double[] temperatureSeries = {};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
    ...
    public void testGreater() {
        double[] temperatureSeries = {3.0, -5.0, 1.0, 5.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double[] expResult = new double[]{3.0, 5.0};
    ...
    public void testAddWithLowTemp() {
        double[] temperatureSeries = {1.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);

        // expect exception here
        seriesAnalysis.addTemps(new double[]{-300.0});
    }
    ...
    public void testAdd() {
        double[] temperatureSeries = {3.0, -5.0, 1.0, 5.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        seriesAnalysis.addTemps(new double[]{4.0, 7.0});
        double[] expResult = new double[]{3.0, -5.0, 1.0, 5.0, 4.0, 7.0, 0.0, 0.0};
